...
const slides = [
  {
    ...
    image: "/assets/footerimg.jpg", // Replace with your transparent player image
  ...
  },
  {
    ...
    image: "/assets/footerimg.jpg", // Replace with your second player image
  ...
  return (
    <main className="min-h-screen bg-zinc-50 font-sans">
     <Navbar />
      ...
      {/* 1. BACKGROUND LAYERS (Static across slides) */}
      <div className="absolute inset-0 w-full h-full z-0">
        {/* Base Gradient: Blue (left) to Pink (right) */}
        <div className="absolute inset-0 bg-gradient-to-r from-[#051038] via-[#1a237e] to-[#c2185b]" />
        
        {/* Floor Effect (Horizon line) */}
        ...
        {slides.map((slide, index) => (
          ...
          >
            ...
            <div className="flex-1 w-full h-[300px] md:h-[500px] lg:h-[600px] relative flex items-center justify-center md:justify-end mt-8 md:mt-0">
               {/* 
                  NOTE: For best results, use a PNG image of a player with a transparent background.
                  The example assumes the image is centered or aligned right.
               */}
               <div className="relative w-full h-full">
                  <Image
                    src={slide.image} // Make sure this path is valid in your public folder
      ...
      {/* 3. FLOATING SOCIAL SIDEBAR (Desktop) */}
    ...
    <div className="w-full bg-gray-50">
      ...
      {/* 1. TOP SPACER (To allow the card to float) */}
      <div className="w-full h-32 md:h-48 bg-gray-50"  />

      {/* 2. MAIN COLORED SECTION */}
      <section className="relative w-full bg-gradient-to-br from-[#d66095] via-[#a259e6] to-[#4a148c] rounded-t-[40px] md:rounded-t-[60px] pb-16 px-4 md:px-0">
        ...
        {/* Positioned absolute to overlap the top edge */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[90%] max-w-4xl z-20">
          <div className="relative mt-15 sm:mt-0 bg-[#1d2472] rounded-xl overflow-hidden shadow-2xl border-[3px] border-[#d66095]/50">
            ...
            <div className="absolute inset-0">
               {/* Replace with a stadium background image */}
        ...
        {/* Top padding is huge to push content below the floating card */}
        <div className="pt-48 md:pt-40 max-w-6xl mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="group relative aspect-[4/5] md:aspect-[3/4] rounded-2xl overflow-hidden bg-black shadow-xl cursor-pointer">
              <Image 
                src="/assets/footerimg.jpg" // Replace with actual video thumbnail
                alt="Video Thumbnail" 
                fill 
            ...
            <div className="relative aspect-[4/5] md:aspect-[3/4] rounded-2xl overflow-hidden bg-gray-800 shadow-xl">
              <Image 
                src="/assets/logo.jpg" // Replace with trophy image
                alt="Trophy" 
                fill 
            ...
            <div className="relative aspect-[4/5] md:aspect-[3/4] rounded-2xl overflow-hidden bg-gray-800 shadow-xl">
               <Image 
                src="/assets/footerimg.jpg" // Replace with action shot
                alt="Game Action" 
                fill 
                className="object-cover group-hover:scale-105 transition-transform duration-500" 
              />
